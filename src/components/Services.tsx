...
const Services = () => {
  ...
  return (
    <>
      <section
        id="services"
        className="relative z-10 pt-10 pb-16 md:pt-16 md:pb-20 bg-background"
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary whitespace-nowrap">Our Clinical Services</h2>
            <p className="text-sm md:text-base text-foreground/80 mt-2">Dedicated to your oral health and beautiful smile.</p>
          </div>
